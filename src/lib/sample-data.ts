...
export const sampleEvidence: Evidence[] = [
  ...
  },
  {
    ...
    credibility_explanation: "Primary government transcript with named witnesses and stable provenance. It documents sworn testimony, but the underlying claims still require independent corroborating records.",
