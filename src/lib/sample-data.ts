...
export const sampleEvidence: Evidence[] = [
  ...
  },
  {
    ...
    content_text: "Public testimony describing unidentified craft reports and alleged retrieval programs.",
    credibility_score: 68,
    credibility_explanation: "Named witnesses and public setting improve provenance; claims remain second-hand without independently archived technical data.",
...
export const sampleConnections: Connection[] = [
  ...
  },
  {
    ...
    type: "supports",
    weight: 0.7,
    ai_reason: "Public testimony aligns with existing UAP disclosure claims but needs documentary support.",
    created_at: now
  },
  {
    id: "conn-05",
